...
//parameter H_Active	=	1924;
//parameter H_Front		=	24;
//parameter H_Start		=	296;
//parameter H_End		=	1320;
////-------------------------------//
//// 垂直扫描参数的设定1924*600	60HZ  	
////-------------------------------//
...
//parameter V_Front		=	0;
//parameter V_Start		=	28;
//parameter V_End		=	628;
 localparam H_ACTIVE_1280_720 = 16'd1924;
 localparam H_FP_1280_720 = 16'd24;
 localparam H_SYNC_1280_720 = 16'd136;
 localparam H_BP_1280_720 = 16'd160;
 localparam V_ACTIVE_1280_720 = 16'd600;
 localparam V_FP_1280_720 = 16'd4;
 localparam V_SYNC_1280_720 = 16'd0;
 localparam V_BP_1280_720 = 16'd4;
